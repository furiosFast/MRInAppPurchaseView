...
CGFloat kBorderedButtonDefaultBorderWidth = 1.0;
CGFloat kBorderedButtonDefaultCornerRadius = 4.0;

@implementation BorderedButton
{
	BorderedView* _borderView; // the border around the button
...
-(void)setup
{
	if(nil == _titleLabel)
	{
		...
		_cornerRadius = kBorderedButtonDefaultCornerRadius;
		_borderWidth = kBorderedButtonDefaultBorderWidth;
		
		// view defaults
		self.backgroundColor = [UIColor clearColor];
		
		// the border view
		_borderView = [[BorderedView alloc] initWithFrame:self.bounds];
